...
@section('content')
    @guest
        <section id="Home" class="pb-5 pt-3 text-dark" style="background-color: #6EF3D6">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 my-auto">
                        <h1 class="" style="font-size: 4.3rem;">Boost Your Business <br>
                            with New Offers!</h1>
                        <br>
                ...
                <div class="row d-flex">
                    <div class="col-md-7 d-md-inline d-none my-auto border-end border-2 ">
                        <div class="col-md-10 m-auto">
                            <h2 class="mb-3">Create your account now</h2>
                        </div>
                        @include('layouts.partials.register-form')
                    </div>
                    <div class=" col-md-4">
                        <h1 class="">Contact Info</h1>
                        <div class="ms-4 text-muted mt-3">
